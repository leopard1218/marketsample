    ...
    <div className='section-wrapper'>
      <div className='nft-sell-wrapper'>
        <div className='row justify-content-center gx-4 gy-3'>
          {
            collections.map(collection => <PopularArtistItem nftImg={collection.bannerImg} artistImg={collection.symbolImg} ranking='01' name='VeThugs' price='$23,002.98' link={`/explore/all/collections/${collection.contractAddress}`} />)
          }
