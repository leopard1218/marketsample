...
const AuthorAll = () => <section className='explore-section padding-top padding-bottom'>
  <div className='container-xl container-lg container-md container-sm'>
    <div className='section-header justify-content-between'>
      <div className='header-title'>
        ...
        <h3>All VNFT Creators</h3>
      </div>
      <SearchSmall label='Creators' />
    </div>
            ...
            <div className='nft-item style-2'>
              <div className='nft-inner'>
                <div className='nft-thumb'>
                  <img loading='lazy' src='/assets/images/nft-item/style-2/01.jpg' alt='nft-img' />
                </div>
